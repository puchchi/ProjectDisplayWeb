                ...
                <div className="px-5 md:px-10 mx-auto max-w-custom grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-3 justify-between items-center h-full">
                    ...
                    <div className="flex justify-end">
                        <Link href="/artistonboarding">
                            <a className="text-sm text-dark font-medium p-3 tracking-wide hover:bg-gray-100 rounded-full hidden sm:inline-flex">{uistring.header.becomeAnArtist}</a>
                        </Link>
                      ...
                      `}>
                        ...
                        border border-transparent m-[-1px] rounded-full flex`} onClick={locationWidgetClicked}>
                            ...
                            <label className="cursor-pointer py-3.5 px-8 block z-1">
                                <div>
                                    <div className="font-bold text-xs pb-0.5 text-gray-800 tracking-wide">
                                        {uistring.header.location}
                                    </div>
                                    <input autoFocus ref={locationInputRef} type="text" placeholder={placeholder.header.locationPlaceholder} className="block w-full bg-transparent outline-none text-sm font-semibold overflow-ellipsis
                                 text-gray-800 expanded-search-placeholder tracking-wide cursor-pointer md:w-48" onChange={e => setLocationWidgetValue(e.target.value)}
                         ...
                         border border-transparent m-[-1px] rounded-full flex `} onClick={serviceWidgetClicked}>
                            <label className="cursor-pointer py-3.5 px-8 block z-1">
                                <div>
                                 ...
                                 text-gray-800 expanded-search-placeholder tracking-wide cursor-pointer md:w-48" onChange={e => setServicesWidgetValue(e.target.value)}
